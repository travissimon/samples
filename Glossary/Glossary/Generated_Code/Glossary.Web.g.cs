...
namespace Glossary.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("Glossary-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// <summary>
    /// The 'GlossaryEntry' entity class.
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/Glossary.Web")]
    public sealed partial class GlossaryEntry : Entity
    {
        ...
        public string Term
        {
            ...
            set
            {
                if ((this._term != value))
                {
                    ...
                    this.RaiseDataMemberChanging("Term");
                    this.ValidateProperty("Term", value);
                    this._term = value;
                    this.RaiseDataMemberChanged("Term");
                    this.OnTermChanged();
                }
            }
        }
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("Glossary-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
...
namespace Glossary.Web.Services
{
    ...
    /// <summary>
    /// The domain context corresponding to the 'GlossaryService' domain service.
    /// </summary>
    public sealed partial class GlossaryContext : DomainContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryContext"/> class.
        /// </summary>
        public GlossaryContext() : 
                this(new WebDomainClient<IGlossaryServiceContract>(new Uri("Glossary-Web-Services-GlossaryService.svc", UriKind.Relative)))
        {
        }
        
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryContext"/> class with the specified service URI.
        /// </summary>
        /// <param name="serviceUri">The GlossaryService service URI.</param>
        public GlossaryContext(Uri serviceUri) : 
                this(new WebDomainClient<IGlossaryServiceContract>(serviceUri))
        {
        }
        ...
        /// <summary>
        /// Gets the set of <see cref="GlossaryEntry"/> entities that have been loaded into this <see cref="GlossaryContext"/> instance.
        /// </summary>
        public EntitySet<GlossaryEntry> GlossaryEntries
        {
            get
            {
                return base.EntityContainer.GetEntitySet<GlossaryEntry>();
            }
        }
        
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="GlossaryEntry"/> entities using the 'GetGlossaryEntries' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="GlossaryEntry"/> entities.</returns>
        public EntityQuery<GlossaryEntry> GetGlossaryEntriesQuery()
        {
            this.ValidateMethod("GetGlossaryEntriesQuery", null);
            return base.CreateQuery<GlossaryEntry>("GetGlossaryEntries", null, false, true);
        }
        ...
        protected override EntityContainer CreateEntityContainer()
        {
            return new GlossaryContextEntityContainer();
        }
        
        /// <summary>
        /// Service contract for the 'GlossaryService' domain service.
        /// </summary>
        [ServiceContract()]
        public interface IGlossaryServiceContract
        {
            
            /// <summary>
            /// Asynchronously invokes the 'GetGlossaryEntries' operation.
            /// </summary>
            /// <param name="callback">Callback to invoke on completion.</param>
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/GlossaryService/GetGlossaryEntriesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/GlossaryService/GetGlossaryEntries", ReplyAction="http://tempuri.org/GlossaryService/GetGlossaryEntriesResponse")]
            [WebGet()]
            IAsyncResult BeginGetGlossaryEntries(AsyncCallback callback, object asyncState);
            
            /// <summary>
            /// Completes the asynchronous operation begun by 'BeginGetGlossaryEntries'.
            /// </summary>
            /// <param name="result">The IAsyncResult returned from 'BeginGetGlossaryEntries'.</param>
            /// <returns>The 'QueryResult' returned from the 'GetGlossaryEntries' operation.</returns>
            QueryResult<GlossaryEntry> EndGetGlossaryEntries(IAsyncResult result);
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/GlossaryService/SubmitChangesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/GlossaryService/SubmitChanges", ReplyAction="http://tempuri.org/GlossaryService/SubmitChangesResponse")]
            IAsyncResult BeginSubmitChanges(IEnumerable<ChangeSetEntry> changeSet, AsyncCallback callback, object asyncState);
        ...
        internal sealed class GlossaryContextEntityContainer : EntityContainer
        {
            
            public GlossaryContextEntityContainer()
            {
                this.CreateEntitySet<GlossaryEntry>(EntitySetOperations.All);
            }
        }
    }
}
